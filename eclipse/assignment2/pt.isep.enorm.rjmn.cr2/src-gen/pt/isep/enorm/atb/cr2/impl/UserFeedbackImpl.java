 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.atb.cr2.impl.UserFeedbackImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.atb.cr2.impl.UserFeedbackImpl#getSubject <em>Subject</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class UserFeedbackImpl extends MinimalEObjectImpl.Container implements UserFeedback {
	...
	public void setSubject(Subject newSubject) {
		if (newSubject != eInternalContainer()
			...
			if (newSubject != null)
				msgs = ((InternalEObject) newSubject).eInverseAdd(this, Cr2Package.SUBJECT__USER_FEEDBACK,
						Subject.class, msgs);
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		...
		case Cr2Package.USER_FEEDBACK__SUBJECT:
			return eInternalContainer().eInverseRemove(this, Cr2Package.SUBJECT__USER_FEEDBACK, Subject.class, msgs);
		}
