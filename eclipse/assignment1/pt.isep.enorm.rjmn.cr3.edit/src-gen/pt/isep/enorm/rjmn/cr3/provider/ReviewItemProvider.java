...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.rjmn.cr3.Review} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Review_gradeType_feature",
								"_UI_Review_type"),
						Cr3Package.Literals.REVIEW__GRADE_TYPE, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Review_reviewType_feature",
								"_UI_Review_type"),
						Cr3Package.Literals.REVIEW__REVIEW_TYPE, true, false, false,
						ItemPropertyDescriptor.GENERIC_VALUE_IMAGE, null, null));
	}
