...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.rjmn.cr3.Comment} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CommentItemProvider extends UserFeedbackItemProvider {
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_reply_feature",
								"_UI_Comment_type"),
						Cr3Package.Literals.COMMENT__REPLY, true, false, false,
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_moderation_feature",
								"_UI_Comment_type"),
						Cr3Package.Literals.COMMENT__MODERATION, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
		...
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						getString("_UI_PropertyDescriptor_description", "_UI_Comment_commentType_feature",
								"_UI_Comment_type"),
						Cr3Package.Literals.COMMENT__COMMENT_TYPE, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cr3Package.Literals.COMMENT__MODERATION_PROCESS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(Cr3Package.Literals.COMMENT__MODERATION_PROCESS,
				Cr3Factory.eINSTANCE.createModerationProcess()));
	}
