 ...
 * </p>
 * <ul>
 *   <li>{@link pt.isep.enorm.rjmn.cr3.impl.SubjectImpl#getName <em>Name</em>}</li>
 *   <li>{@link pt.isep.enorm.rjmn.cr3.impl.SubjectImpl#getUserFeedback <em>User Feedback</em>}</li>
 *   <li>{@link pt.isep.enorm.rjmn.cr3.impl.SubjectImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SubjectImpl extends MinimalEObjectImpl.Container implements Subject {
	...
	protected EClass eStaticClass() {
		return Cr3Package.Literals.SUBJECT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Cr3Package.SUBJECT__NAME, oldName, name));
	}
	...
	public EList<UserFeedback> getUserFeedback() {
		if (userFeedback == null) {
			userFeedback = new EObjectContainmentWithInverseEList<UserFeedback>(UserFeedback.class, this,
					Cr3Package.SUBJECT__USER_FEEDBACK, Cr3Package.USER_FEEDBACK__SUBJECT);
		}
		return userFeedback;
	}
	...
	public EList<Feature> getFeature() {
		if (feature == null) {
			feature = new EObjectContainmentEList<Feature>(Feature.class, this, Cr3Package.SUBJECT__FEATURE);
		}
		return feature;
	}
