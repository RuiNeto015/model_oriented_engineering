...
/**
 * This is the item provider adapter for a {@link pt.isep.enorm.atb.cr2.Subject} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SubjectItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addNamePropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						...
						Cr2Package.Literals.SUBJECT__NAME, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(Cr2Package.Literals.SUBJECT__USER_FEEDBACK);
			childrenFeatures.add(Cr2Package.Literals.SUBJECT__FEATURE);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(
				createChildParameter(Cr2Package.Literals.SUBJECT__USER_FEEDBACK, Cr2Factory.eINSTANCE.createReview()));

		newChildDescriptors.add(
				createChildParameter(Cr2Package.Literals.SUBJECT__USER_FEEDBACK, Cr2Factory.eINSTANCE.createComment()));

		newChildDescriptors
				.add(createChildParameter(Cr2Package.Literals.SUBJECT__FEATURE, Cr2Factory.eINSTANCE.createFeature()));
	}
