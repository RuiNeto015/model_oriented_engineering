...
import org.xtext.example.mydsl.ide.contentassist.antlr.internal.InternalAssign5Parser;
import org.xtext.example.mydsl.services.Assign5GrammarAccess;

public class Assign5Parser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(Assign5GrammarAccess grammarAccess) {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, Assign5GrammarAccess grammarAccess) {
	...
	@Override
	protected InternalAssign5Parser createParser() {
		InternalAssign5Parser result = new InternalAssign5Parser(null);
