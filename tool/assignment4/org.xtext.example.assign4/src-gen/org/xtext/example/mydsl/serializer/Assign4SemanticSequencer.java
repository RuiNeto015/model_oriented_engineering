...
public class Assign4SemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (name=EString reply?='reply' moderation?='moderation' commentType=CommentType? moderationProcess=ModerationProcess?)
	 * </pre>
	 */
	...
	protected void sequence_End(ISerializationContext context, End semanticObject) {
		...
		feeder.accept(grammarAccess.getEndAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_Feature(ISerializationContext context, Feature semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getFeatureAccess().getNameEStringParserRuleCall_1_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	protected void sequence_Manual(ISerializationContext context, Manual semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getManualAccess().getNameEStringParserRuleCall_3_0(), semanticObject.getName());
		feeder.accept(grammarAccess.getManualAccess().getNextApproveStepEStringParserRuleCall_8_0_1(), semanticObject.eGet(Cr2Package.Literals.VALIDATION_STEP__NEXT_APPROVE, false));
		feeder.accept(grammarAccess.getManualAccess().getNextRejectStepEStringParserRuleCall_13_0_1(), semanticObject.eGet(Cr2Package.Literals.VALIDATION_STEP__NEXT_REJECT, false));
		feeder.finish();
	}
	...
	protected void sequence_Model(ISerializationContext context, Model semanticObject) {
		...
		feeder.accept(grammarAccess.getModelAccess().getSubjectSubjectParserRuleCall_5_0(), semanticObject.getSubject());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=EString (feature+=Feature feature+=Feature*)? userFeedback+=UserFeedback userFeedback+=UserFeedback*)
	 * </pre>
	 */
